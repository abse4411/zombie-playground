...
const GAMECONFIG = {
  ...
  supports: {
    airstrike: {
      id: 'airstrike', icon: '✈', name: '战机轰炸', max: 2, pack: 1, price: 3000,
      desc: '标记前方52米×10米弹幕带，2.2秒后轰炸机临空沿带投下12枚航弹——注意自己别站在弹着区里。',
      stats: [['单弹伤害', 180], ['弹幕带', '52m × 10m'], ['航弹', '12枚'], ['前摇', '2.2s']],
    },
    supply: {
      id: 'supply', icon: '📦', name: '空投补给', max: 3, pack: 1, price: 2000,
      desc: '降落伞空投补给箱至身边：全弹药补满 + 医疗包×3 + 手雷×2/燃烧瓶×1 + 现金。落地有小额砸落伤害。',
      stats: [['内容', '全弹药+医疗×3+$800'], ['投掷物', '手雷×2/燃烧瓶×1'], ['落地', '半径3m击倒']],
    },
    drone: {
      id: 'drone', icon: '🛸', name: '攻击无人机', max: 2, pack: 1, price: 3600,
      desc: '武装无人机伴飞35秒：自动索敌22米内感染体，双联机枪点射（爆头按2倍计）。',
      stats: [['持续', '35s'], ['索敌', '22m'], ['火力', '28 dmg / 0.4s']],
    },
    sentry: {
