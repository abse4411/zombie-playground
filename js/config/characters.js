/* ============================================================
 * 角色系统（v6.2）—— 6名可选角色（男女/职业/属性差异）
 * v18.1：新增 slots 武器栏位配置（主/副/近战各槽数量，商城可再扩容）
 * ============================================================ */
const CHARACTERS = [
  {
    ...
    slots: { primary: 2, secondary: 1, melee: 1 },   // 双主武器火力组
  ...
  },
  {
    ...
    slots: { primary: 1, secondary: 2, melee: 1 },   // 双副枪快速游走
  ...
  },
  {
    ...
    slots: { primary: 2, secondary: 2, melee: 1 },   // 满配火力大师
  ...
  },
  {
    ...
    slots: { primary: 1, secondary: 1, melee: 2 },   // 医疗铲+军刀双近战
  ...
  },
  {
    ...
    slots: { primary: 2, secondary: 1, melee: 1 },   // 狙击位双长枪
  ...
  },
  {
    ...
    slots: { primary: 1, secondary: 2, melee: 1 },   // 爆破手双副枪
