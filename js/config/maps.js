...
/* ========== 6. 迷雾森林（番外·猎人营地） ========== */
  ...
  rooftops: {
    ...
    props: [
      ...
      // 二层楼板（含楼梯井洞口，v5.2）：北廊 / 南廊 / 西内条 / 西北 / 西南 / 东内条 / 东北 / 东南
      { t: 'b', x: 0, z: -14.5, w: 40, h: 0.5, d: 11, y: 4.5, c: 0x3a3f46 },
      { t: 'b', x: 0, z: 14.5, w: 40, h: 0.5, d: 11, y: 4.5, c: 0x3a3f46 },
      { t: 'b', x: -12.5, z: 0, w: 7, h: 0.5, d: 18, y: 4.5, c: 0x3a3f46 },
      { t: 'b', x: -18, z: -6.9, w: 8, h: 0.5, d: 4.2, y: 4.5, c: 0x3a3f46 },
      { t: 'b', x: -18, z: 7.5, w: 8, h: 0.5, d: 3, y: 4.5, c: 0x3a3f46 },
      { t: 'b', x: 12.5, z: 0, w: 7, h: 0.5, d: 18, y: 4.5, c: 0x3a3f46 },
      { t: 'b', x: 18, z: 6.9, w: 8, h: 0.5, d: 4.2, y: 4.5, c: 0x3a3f46 },
      { t: 'b', x: 18, z: -7.5, w: 8, h: 0.5, d: 3, y: 4.5, c: 0x3a3f46 },
      ...
      // 二层四边护栏矮墙（防坠落，1.2m 胸墙）
      { t: 'b', x: -20, z: 0, w: 0.6, h: 1.7, d: 40, y: 4.5, c: 0x363b42 },
      { t: 'b', x: 20, z: 0, w: 0.6, h: 1.7, d: 40, y: 4.5, c: 0x363b42 },
      { t: 'b', x: 0, z: -20, w: 40, h: 1.7, d: 0.6, y: 4.5, c: 0x363b42 },
      { t: 'b', x: 0, z: 20, w: 40, h: 1.7, d: 0.6, y: 4.5, c: 0x363b42 },
      // 双侧楼梯由 STRUCTS.staircase 程序化生成（0.5m踏步x10级，玩家/丧尸可踏步上下）
      // 直升机坪标记（二层北侧回廊）
      { t: 'c', x: 0, z: -14.5, r: 4, h: 0.12, y: 5.0, c: 0x3a4048, nc: true },
    ],
    structures: [
      { type: 'staircase', x: -17.5, z: 6, dirZ: -1, steps: 10, stepH: 0.5, stepD: 1.2, width: 3 },
      { type: 'staircase', x: 17.5, z: -6, dirZ: 1, steps: 10, stepH: 0.5, stepD: 1.2, width: 3 },
  ...
  /* ========== 9. 下水道·泄源管网 ========== */
  sewer: {
    id: 'sewer', name: '下水道·泄源管网', subtitle: '赤潮从这里的管壁渗出', mode: 'both',
    desc: '病毒真正的泄源点：城市地下排水主枢纽。中央圆形集水井仍在泄出荧光浊流，环形检修道上爬满了趋光而来的感染体。',
    size: 58, groundColor: 0x1a2018, sky: 0x0a0f0a, fogColor: 0x0e140e, fogDensity: 0.028,
    hemi: { sky: 0x3a5a46, ground: 0x0e1210, i: 0.7 },
    dir: { c: 0x66ff99, i: 0.28, x: -20, y: 50, z: 10 },
    lights: [
      { x: 0, y: 5.5, z: 0, c: 0x66ff99, i: 0.95, d: 20 },
      { x: -16, y: 4, z: -14, c: 0x88aaff, i: 0.75, d: 16 },
      { x: 16, y: 4, z: 14, c: 0x88ffcc, i: 0.75, d: 16 },
      { x: 14, y: 4, z: -16, c: 0xb08aff, i: 0.7, d: 15 },
      { x: -14, y: 4, z: 16, c: 0x66ff99, i: 0.7, d: 15 },
    ],
    props: [
      // 中央集水井：环形检修走道（地标+环形回流）
      { t: 'c', x: 0, z: 0, r: 5.6, h: 0.6, c: 0x242e24 },                       // 井芯
      { t: 'c', x: 0, z: 0, r: 8.2, h: 0.55, c: 0x2a342a, nc: true },            // 外环走道(可踏上)
      { t: 'b', x: 0, z: 0, w: 11.4, h: 0.6, d: 1.2, c: 0x28322c },              // 检修桥(南北)
      { t: 'b', x: 0, z: 0, w: 1.2, h: 0.6, d: 11.4, c: 0x28322c },              // 检修桥(东西)
      // 格棚高台 0.5m（高低差 kill-box）
      { t: 'b', x: -16, z: -16, w: 7, h: 0.5, d: 7, c: 0x222a22 }, { t: 'b', x: 16, z: 16, w: 7, h: 0.5, d: 7, c: 0x222a22 },
      { t: 'b', x: 16, z: -16, w: 6, h: 1.0, d: 6, c: 0x26302a },                // 二层高台
      // 粗水管阵（胸高遮断视线）
      { t: 'c', x: -22, z: 2, r: 0.8, h: 3.2, c: 0x3a463a }, { t: 'c', x: -20.4, z: 2, r: 0.8, h: 3.2, c: 0x3a463a },
      { t: 'c', x: 22, z: -2, r: 0.8, h: 3.2, c: 0x3a463a }, { t: 'c', x: 20.4, z: -2, r: 0.8, h: 3.2, c: 0x3a463a },
      { t: 'c', x: 2, z: -22, r: 0.7, h: 3.0, c: 0x404c40 }, { t: 'c', x: -2, z: 22, r: 0.7, h: 3.0, c: 0x404c40 },
      // 泵房与格栅墙
      { t: 'b', x: -24, z: 18, w: 6, h: 3.2, d: 3, c: 0x2c342c }, { t: 'b', x: 24, z: -18, w: 6, h: 3.2, d: 3, c: 0x2c342c },
      { t: 'b', x: -12, z: 20, w: 5, h: 2.2, d: 0.5, c: 0x364236 }, { t: 'b', x: 12, z: -20, w: 5, h: 2.2, d: 0.5, c: 0x364236 },
      { t: 'b', x: 20, z: 12, w: 0.5, h: 2.2, d: 5, c: 0x364236 }, { t: 'b', x: -20, z: -12, w: 0.5, h: 2.2, d: 5, c: 0x364236 },
      // 泵机与杂物桶
      { t: 'c', x: -6, z: -14, r: 0.5, h: 1.2, c: 0x2e3a30 }, { t: 'c', x: 6, z: 14, r: 0.5, h: 1.2, c: 0x2e3a30 },
      { t: 'b', x: 8, z: -8, w: 2.2, h: 0.8, d: 0.7, c: 0x3a4238 }, { t: 'b', x: -8, z: 8, w: 2.2, h: 0.8, d: 0.7, c: 0x3a4238 },
    ],
    structures: [
      { type: 'lightPole', x: -10, z: 4, c: 0x66ff99, i: 0.6, d: 14 },
      { type: 'lightPole', x: 10, z: -4, c: 0x88aaff, i: 0.6, d: 14 },
      { type: 'tent', x: -24, z: 22, c: 0x3a4a3a },
    ],
    spawns: [
      { x: -24, z: -24 }, { x: 0, z: -26 }, { x: 24, z: -24 }, { x: -26, z: 0 },
      { x: 26, z: 0 }, { x: -24, z: 24 }, { x: 24, z: 24 }, { x: 0, z: 26 },
    ],
    playerSpawn: { x: 0, z: 20, yaw: 0 },
    buyZone: { x: 5, z: 22, r: 4.5 },
  },

  /* ========== 10. 雪原哨站 ========== */
  snowOutpost: {
    id: 'snowOutpost', name: '雪原哨站', subtitle: '极北最后一个观察哨', mode: 'both',
    desc: '北极圈外围的方舟观察哨——风暴掩埋了补给，瞭望塔的探照灯是这片雪原唯一的光。赤潮的爬行者正踏雪而来。',
    size: 66, groundColor: 0xaebcc8, sky: 0x7e8c9a, fogColor: 0x9aa8b6, fogDensity: 0.015,
    hemi: { sky: 0xc8d4e0, ground: 0x6a7682, i: 0.85 },
    dir: { c: 0xdde8f4, i: 0.55, x: 30, y: 55, z: -20 },
    lights: [
      { x: 0, y: 8, z: 0, c: 0xfff4dd, i: 1.0, d: 26 },
      { x: -20, y: 4, z: -16, c: 0xbfd8ff, i: 0.7, d: 22 },
      { x: 20, y: 4, z: 16, c: 0xbfd8ff, i: 0.7, d: 22 },
      { x: 18, y: 4, z: -18, c: 0xffe8c8, i: 0.65, d: 20 },
      { x: -18, y: 4, z: 18, c: 0xffe8c8, i: 0.65, d: 20 },
    ],
    props: [
      // 北主阵地：沙袋环+雪墙腰高掩体（三线之主线）
      { t: 'b', x: 0, z: -12, w: 8, h: 1.2, d: 0.7, c: 0xd8e2ea }, { t: 'b', x: -5, z: -14, w: 6, h: 1.2, d: 0.7, ry: 0.5, c: 0xd8e2ea }, { t: 'b', x: 5, z: -14, w: 6, h: 1.2, d: 0.7, ry: -0.5, c: 0xd8e2ea },
      // 东西副巷：雪墙+集装箱节点
      { t: 'b', x: -16, z: 4, w: 0.7, h: 1.2, d: 8, c: 0xd8e2ea }, { t: 'b', x: 16, z: -4, w: 0.7, h: 1.2, d: 8, c: 0xd8e2ea },
      { t: 'b', x: -20, z: -6, w: 4.5, h: 2.6, d: 2.4, ry: 0.2, c: 0x3a6a5a }, { t: 'b', x: 20, z: 6, w: 4.5, h: 2.6, d: 2.4, ry: -0.3, c: 0x8a3a3a },
      { t: 'b', x: -24, z: 12, w: 4.5, h: 2.6, d: 2.4, ry: 0.5, c: 0x3a5a8a }, { t: 'b', x: 24, z: -12, w: 4.5, h: 2.6, d: 2.4, ry: -0.2, c: 0x8a6a3a },
      // 南侧生活区（出生掩护）
      { t: 'b', x: -8, z: 20, w: 5, h: 3, d: 3.4, c: 0x4a4e56 }, { t: 'b', x: 8, z: 20, w: 5, h: 3, d: 3.4, c: 0x4a4e56 },
      { t: 'b', x: -8, z: 20, w: 5.6, h: 0.4, d: 4, y: 3, c: 0x2e323a, nc: true }, { t: 'b', x: 8, z: 20, w: 5.6, h: 0.4, d: 4, y: 3, c: 0x2e323a, nc: true },
      // 雪堆与补给箱
      { t: 'c', x: -12, z: -8, r: 1.1, h: 0.9, c: 0xc4d0da }, { t: 'c', x: 12, z: 8, r: 1.1, h: 0.9, c: 0xc4d0da },
      { t: 'b', x: 0, z: 10, w: 2, h: 0.9, d: 1.2, c: 0x5a6248 }, { t: 'b', x: -3, z: 8, w: 1.6, h: 0.8, d: 1, c: 0x4a5240 },
      { t: 'b', x: 10, z: -8, w: 2, h: 0.9, d: 1.2, ry: 0.4, c: 0x5a6248 },
      // 油罐与缆桩
      { t: 'c', x: -18, z: 18, r: 1.3, h: 3, c: 0x5a6248 }, { t: 'c', x: 18, z: -18, r: 1.3, h: 3, c: 0x5a6248 },
      // 高台（阶梯可上）
      { t: 'b', x: 12, z: -22, w: 6, h: 0.5, d: 6, c: 0x9aa8b4 }, { t: 'b', x: 12, z: -26.5, w: 2, h: 1.0, d: 3, c: 0x8a98a4 },
    ],
    structures: [
      { type: 'watchtower', x: 0, z: 0 },
      { type: 'sandbagRing', x: 0, z: -12, r: 9 },
      { type: 'tent', x: -14, z: 14, c: 0x4a5a6a }, { type: 'tent', x: 14, z: 14, c: 0x6a5a4a },
      { type: 'deadTree', x: -28, z: -24 }, { type: 'deadTree', x: 28, z: 24 }, { type: 'deadTree', x: -30, z: 6 },
      { type: 'lightPole', x: -12, z: -2, c: 0xbfd8ff, i: 0.7 }, { type: 'lightPole', x: 12, z: 2, c: 0xbfd8ff, i: 0.7 },
      { type: 'lightPole', x: 0, z: 16, c: 0xfff4dd, i: 0.8, d: 20 },
    ],
    spawns: [
      { x: -26, z: -26 }, { x: 0, z: -28 }, { x: 26, z: -26 }, { x: -30, z: 0 },
      { x: 30, z: 0 }, { x: -28, z: 26 }, { x: 28, z: 26 }, { x: -12, z: 30 }, { x: 12, z: 30 }, { x: 0, z: 32 },
    ],
    playerSpawn: { x: 0, z: 24, yaw: 0 },
    buyZone: { x: 6, z: 26, r: 4.5 },
  },
};
